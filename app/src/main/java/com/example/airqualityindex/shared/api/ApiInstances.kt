    ...
    companion object {
        private const val BASE_URL = "https://data.epa.gov.tw/api/v2/"
         ...
         fun getRetrofitInstance(): AQIService {
            return RetrofitInstances.getRetrofitInstance(this.BASE_URL)
        ...
        fun getSensorThingsInstance(): SensorThingsService {
            return RetrofitInstances.getX509RetrofitInstance(this.SENSOR_THINGS_URL)
        ...
        fun getCertificationInstance(): CertificationService {
            return RetrofitInstances.getRetrofitInstance(this.CERTIFICATION_URL)
        ...
        fun getWeatherInstance(): WeatherForecastService {
            return RetrofitInstances.getRetrofitInstance(this.WEATHER_URL)
